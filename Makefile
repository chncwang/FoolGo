...
objects = foolishgo.o rand.o vector_util.o position.o
...
board_in_gm_h = board_in_gm.h $(board_h) $(chain_set_h) board_in_gm-TLT.h \
		board_in_gm_TEST.h bitset_util.h $(eye_set_h)
...
eye_set_h = def.h position.h eye_set.h eye_set-TLT.h
vector_util_h = vector_util.h position.h
